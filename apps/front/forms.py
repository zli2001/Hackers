#encoding:utf-8
from wtforms import StringField,IntegerField,TextAreaField,TextField,PasswordField,SubmitField
from wtforms.validators import DataRequired,Length,InputRequired,regexp,Regexp,EqualTo,Email
